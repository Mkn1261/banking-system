...
public class PaymentService {
    ...
    public PaymentOrderResponse createPaymentOrder
        ...
        payment.setCurrency(PaymentStatus.CREATED);
    ...
    private void handlePaymentSuccess(Map<String, Object> payload){
        try {
            ...
            Map<String, Object> paymentData = extraPaymentData(payload);
    ...
    private Map<String, Object> extraPaymentData(Map<String, Object> payload){
